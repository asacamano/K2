 ...
 */
public class HexEncodingByteBufferWritable implements Writable {

  private final ByteBuffer destination;

  public HexEncodingByteBufferWritable(ByteBuffer destination) {
  ...
  public void fillFrom(ByteBuffer buffer) throws CantWriteException {
    ...
    destination.put(hex.getBytes(Util.UTF_8));
  }
