...
public class InstalledDriverTest {
   ...
   */
  @Test
  public final void testRejectNullDriverClass() throws K2Exception {
    try {
   ...
   */
  private InstalledDriver checkAcceptInstallation(Class<? extends Driver> driverClass)
   ...
   */
  private void checkRejectInstallation(Class<? extends Driver> driverClass,
      StorageDriverException.Reason reason, String failMessage) {
    try {
   ...
   */
  @Test
  public final void testRejectUselessDriver() {
    checkRejectInstallation(MockDriver.class, StorageDriverException.Reason.USELESS,
   ...
   */
  @Test
  public final void testAcceptNormalDriver() throws K2Exception {
    InstalledDriver idriver = checkAcceptInstallation(MockDriver.Normal.class);
   ...
   */
  @Test
  public final void testAcceptReadOnlyDriver() throws K2Exception {
    InstalledDriver idriver = checkAcceptInstallation(MockDriver.ReadOnly.class);
   ...
   */
  @Test
  public final void testAcceptWriteOnlyDriver() throws K2Exception {
    InstalledDriver idriver = checkAcceptInstallation(MockDriver.WriteOnly.class);
   ...
   */
  @Test
  public final void testAcceptNoWrapDriver() throws K2Exception {
    InstalledDriver idriver = checkAcceptInstallation(MockDriver.NoWrap.class);
   ...
   */
  @Test
  public final void testRejectNoConstructorDriver() {
    checkRejectInstallation(NoConstructorDriver.class, StorageDriverException.Reason.NO_CONSTRUCTOR,
  ...
  public static class NoConstructorDriver extends MockDriver.Normal {
    public NoConstructorDriver(Object obj) {}
  }
   ...
   */
  @Test
  public final void testRejectAbstractDriver() {
    checkRejectInstallation(AbstractDriver.class, StorageDriverException.Reason.INSTANTIATE_FAIL,
   ...
   */
  @Test
  public final void testAcceptPrivateDriver() throws K2Exception {
    InstalledDriver idriver = checkAcceptInstallation(PrivateDriver.class);
   ...
   */
  @Test
  public final void testRejectPrivateConstructor() {
    checkRejectInstallation(PrivateConstructorDriver.class,
  ...
  public final void testRejectConstructorWithBadThrowables() {
    checkRejectInstallation(ConstructorWithBadThrowablesDriver.class,
  ...
  // Test "data" for the above
  @DriverInfo(id = "mock", name = "Constructor with Bad Throwables Driver", version = "1.0")
  public static class ConstructorWithBadThrowablesDriver extends MockDriver.Normal {
  ...
  public final void testAcceptConstructorWithLegalThrowables() throws K2Exception {
    InstalledDriver idriver = checkAcceptInstallation(ConstructorWithLegalThrowablesDriver.class);
  ...
  // Test "data" for the above
  @DriverInfo(id = "legalcon", name = "Constructor with Legal Throwables Driver", version = "0.1")
  public static class ConstructorWithLegalThrowablesDriver extends MockDriver.Normal {
    public ConstructorWithLegalThrowablesDriver() throws Error, RuntimeException {}
  }
   ...
   */
  @Test
  public final void testRejectNoAnnotation() {
    checkRejectInstallation(NoAnnotationDriver.class, StorageDriverException.Reason.NO_METADATA,
   ...
   */
  @Test
  public final void testRejectEmptyIdentifier() {
    checkRejectInstallation(EmptyIdentifierDriver.class, StorageDriverException.Reason.ILLEGAL_ID,
   ...
   */
  @Test
  public final void testRejectBadIdentifier() {
    checkRejectInstallation(BadIdentifierDriver.class, StorageDriverException.Reason.ILLEGAL_ID,
   ...
   */
  @Test
  public final void testAcceptComplexIdentifier() throws K2Exception {
    InstalledDriver idriver = checkAcceptInstallation(ComplexIdentifierDriver.class);
  ...
  // Test "data" for the above
  @DriverInfo(id = "c0m-p13x+id.", name = "Complex Identifier Driver", version = "1.0a")
