...
public class K2StorageTest {
   ...
   */
  @Test
  public final void testInstallBadDriver() {
   ...
   */
  @Test
  public final void testInstallOneDriver() throws K2Exception {
    K2Storage storage = new K2Storage(context);
   ...
   */
  @Test
  public final void testInstallSeveralDrivers() throws K2Exception {
    K2Storage storage = new K2Storage(context);
   ...
   */
  @Test
  public final void testDriverChurn() throws K2Exception {
    K2Storage storage = new K2Storage(context);
   ...
   */
  @Test
  public void testOpenString() throws K2Exception {
    // Quick instrumentation of K2Storage to detect open(URI) call
    final URI[] openAddress = {null};
    K2Storage storage = new K2Storage(context) {
      @Override
      public Store open(URI address)
          throws IllegalAddressException, NoSuitableDriverException, StoreException {
    ...
    try {
      ...
      assertEquals(IllegalAddressException.Reason.INVALID_URI, expected.getReason());
    }
   ...
   */
  @Test
  public final void testOpenExactDriver() throws K2Exception {
    K2Storage storage = new K2Storage(context);
    ...
    InstalledDriver exactDriver = storage.installDriver(MockDriver.Normal.class);
   ...
   */
  @Test
  public final void testOpenSearchDrivers() throws K2Exception {
    K2Storage storage = new K2Storage(context);
    ...
    assertNotNull(storage.installDriver(MockDriver.Normal.class));
    InstalledDriver acceptFileDriver = storage.installDriver(MockDriver.AcceptFile.class);
   ...
   */
  @Test
  public final void testNullArguments() throws K2Exception {
    K2Storage storage = new K2Storage(context);
    try {
  ...
  private static void checkOpenSuccess(K2Storage storage, URI address,
      Class<? extends Driver> expectedDriver) throws K2Exception {
   ...
   */
  private static void checkOpenFail(K2Storage storage, URI address) throws K2Exception {
    try {
