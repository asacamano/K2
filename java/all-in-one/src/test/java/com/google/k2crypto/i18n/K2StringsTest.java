...
public class K2StringsTest {
  ...
  private static final String TEST_BUNDLE_NAME = "com.google.k2crypto.i18n.test_strings";

  /**
   * Tests getting a string keyed by a digit.
   */
  @Test
  public final void testDigitKey() {
    K2Strings strings = new K2Strings(null, TEST_BUNDLE_NAME, Locale.getDefault());
   ...
   */
  @Test
  public final void testLetterKey() {
    K2Strings strings = new K2Strings(null, TEST_BUNDLE_NAME, Locale.getDefault());
   ...
   */
  @Test
  public final void testMultiline() {
    K2Strings strings = new K2Strings(null, TEST_BUNDLE_NAME, Locale.getDefault());
   ...
   */
  @Test
  public final void testFormatOne() {
    K2Strings strings = new K2Strings(null, TEST_BUNDLE_NAME, Locale.getDefault());
   ...
   */
  @Test
  public final void testFormatTwo() {
    K2Strings strings = new K2Strings(null, TEST_BUNDLE_NAME, Locale.getDefault());
