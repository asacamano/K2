...
public class StoreTest {
   ...
   */
  @Before
  public final void setUp() throws K2Exception {
   ...
   */
  @Test
  public final void testSaveWithWrapping() throws K2Exception {
    URI address = URI.create(normalDriver.getId() + ADDRESS_FRAGMENT);
    Store store = new Store(normalDriver, address);
    MockDriver driver = (MockDriver) store.getDriver();
    store.open();
   ...
   */
  @Test
  public final void testLoadWithWrapping() throws K2Exception {
    URI address = URI.create(normalDriver.getId() + ADDRESS_FRAGMENT);
    Store store = new Store(normalDriver, address);
    MockDriver driver = (MockDriver) store.getDriver();
    store.open();
    ...
    try {
      ...
      assertEquals(StoreIOException.Reason.WRAP_KEY_REQUIRED, expected.getReason());
    ...
    try {
      ...
      assertEquals(StoreIOException.Reason.WRAP_KEY_WRONG, expected.getReason());
      assertEquals(store, expected.getStore());
    }
    assertEquals(3, driver.loadCalls);
    ...
    try {
      ...
      assertEquals(StoreIOException.Reason.WRAP_KEY_UNNECESSARY, expected.getReason());
      assertEquals(store, expected.getStore());
    }
   ...
   */
  @Test
  public final void testEraseWithWrapping() throws K2Exception {
    URI address = URI.create(normalDriver.getId() + ADDRESS_FRAGMENT);
    Store store = new Store(normalDriver, address);
    MockDriver driver = (MockDriver) store.getDriver();
    store.open();
   ...
   */
  @Test
  public final void testAccessBeforeOpen() throws K2Exception {
    URI address = URI.create(normalDriver.getId() + ADDRESS_FRAGMENT);
    Store store = new Store(normalDriver, address);
    MockDriver driver = (MockDriver) store.getDriver();
   ...
   */
  @Test
  public final void testAccessAfterClose() throws K2Exception {
    URI address = URI.create(normalDriver.getId() + ADDRESS_FRAGMENT);
    Store store = new Store(normalDriver, address);
    MockDriver driver = (MockDriver) store.getDriver();
    ...
    try {
      ...
      assertEquals(StoreStateException.Reason.ALREADY_CLOSED, expected.getReason());
      assertEquals(store, expected.getStore());
    }
    try {
      store.wrapWith(wrapKeyA);
   ...
   */
  @Test
  public final void testAccessForReadOnlyDriver() throws K2Exception {
    InstalledDriver readOnlyDriver = new InstalledDriver(context, MockDriver.ReadOnly.class);
    ...
    try {
      ...
      assertEquals(UnsupportedByStoreException.Reason.READ_ONLY, expected.getReason());
      assertEquals(store, expected.getStore());
    }
    try {
      store.erase();
   ...
   */
  @Test
  public final void testAccessForWriteOnlyDriver() throws K2Exception {
    InstalledDriver writeOnlyDriver = new InstalledDriver(context, MockDriver.WriteOnly.class);
    ...
    try {
      ...
      assertEquals(UnsupportedByStoreException.Reason.WRITE_ONLY, expected.getReason());
      assertEquals(store, expected.getStore());
    }
    try {
      store.isEmpty();
   ...
   */
  @Test
  public final void testAccessForNoWrapDriver() throws K2Exception {
    InstalledDriver noWrapDriver = new InstalledDriver(context, MockDriver.NoWrap.class);
    ...
    try {
      ...
      assertEquals(UnsupportedByStoreException.Reason.NO_WRAP, expected.getReason());
      assertEquals(store, expected.getStore());
    }
   ...
   */
  @Test
  public final void testAddressChangeDriver() throws K2Exception {
    InstalledDriver acceptAllDriver = new InstalledDriver(context, MockDriver.AcceptAll.class);
    ...
    assertEquals(address, store.getAddress());
    store.open();
    assertEquals(URI.create(acceptAllDriver.getId() + ADDRESS_FRAGMENT), store.getAddress());
    store.close();
  }
   ...
   */
  @Test
  public final void testRejectNulls() throws K2Exception {
    URI address = URI.create(normalDriver.getId() + ADDRESS_FRAGMENT);
    Store store = new Store(normalDriver, address);
    MockDriver driver = (MockDriver) store.getDriver();
    store.open();
