...
public class IllegalAddressException extends K2Exception {
   ...
   */
  public IllegalAddressException(String address, Reason reason, Throwable cause) {
   ...
   * @param cause The throwable that caused this one.
   */
  public IllegalAddressException(URI address, Reason reason, Throwable cause) {
   ...
   * @param cause The throwable that caused this one.
   */
  public IllegalAddressException(URI address, String details, Throwable cause) {
   ...
   * @param cause The throwable that caused this one.
   */
  private IllegalAddressException(String address, Reason reason, String details, Throwable cause) {
